...
from .models import AccessToken, DownloadGrant, Project, ProjectFile, ProjectMembership, ProjectUpload, TransferEvent, VerificationRequest
...
for model in [ProjectUpload, ProjectFile, VerificationRequest, DownloadGrant, TransferEvent]:
