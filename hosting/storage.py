...
from safe_cli.archive import ArchiveError, MAX_ARCHIVE, MAX_FILES, MAX_UNPACKED, checksum, inspect_archive
...
def prepare_archive(uploaded_file):
    ...
    temporary = None
    try:
        with tempfile.NamedTemporaryFile(dir=root, prefix="incoming-", delete=False) as stream:
