...
\usepackage{fontspec}
\usepackage{amsmath,booktabs,array,xcolor,fancyhdr}
\usepackage{unicode-math}
% macOS resolves the site's -apple-system stack to San Francisco.
\setmainfont{SFNS.ttf}[Path=/System/Library/Fonts/,ItalicFont=SFNSItalic.ttf,AutoFakeBold=1.4]
\setsansfont{SFNS.ttf}[Path=/System/Library/Fonts/,ItalicFont=SFNSItalic.ttf,AutoFakeBold=1.4]
\setmonofont{SFNSMono.ttf}[Path=/System/Library/Fonts/,Scale=MatchLowercase]
% San Francisco does not contain a complete OpenType mathematics font.
