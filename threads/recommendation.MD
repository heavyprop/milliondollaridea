...
The tag scores are L1-normalised in `threads/label_classifier.py`, so the saved tag scores for a post add up to `1`.
...
from threads.user_interests import print_user_interests
